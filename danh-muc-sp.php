<?php
 ...
 <section class="container">
   <nav class="breadcrumbs">
       ...
       <span class="divider">›</span> Danh Mục Sản Phẩm
   </nav>
 </section>
 <section class="container">
    <div class="row">
        ...
        <section class="col-sm-8 col-md-9 col-lg-9 content-center">
            ...
            <div class="products-list products-list-small row">
                ...
                //số sản phẩm trên 1 trang
                    $limit=12;
                //query lấy sản phẩm
                    $LaySP = mysqli_query($ketnoi,"SELECT id FROM san_pham WHERE DanhMuc='".$masp."'");
                ...
                //lấy ra danh sách và gán vào biến $cots:
                    $cots = mysqli_query($ketnoi,"SELECT * FROM san_pham WHERE DanhMuc='".$masp."' LIMIT $start,$limit");
                    foreach($cots as $cot){
